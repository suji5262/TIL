...
public class Parameter {
    ...
    public void setMinimumTotalPay(int minimumTotalPat) {
        this.minimumTotalPay = minimumTotalPat;
    }
    ...
    public String toString() {
        return "Parameter{minimumSpentTime = " + this.minimumSpentTime +
                ", minimumTotalPay = " + this.minimumTotalPay +
                "}";
    }
}
