package smartStore2.src.me.smartstore.project.groups;
...
public class Groups {
    ...
    public Groups(int maxSize) {this.groups = new Group[maxSize]; }

    public int getCount() {return this.count; }

    public int length() {return this.groups.length;}

    private boolean isNull() {return groups == null;}
    ...
    public Group get(int i) {return this.groups[i]; }
